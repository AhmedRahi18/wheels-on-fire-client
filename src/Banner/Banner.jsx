      ...
      <div className="rounded-b-lg bg-[url('https://www.wallpapertip.com/wmimgs/0-1938_download-free-hd-3d-hd-car-fire-wallpaper.jpg')] bg-center bg-cover bg-no-repeat
       md:w-auto">
        <div className="rounded-lg h-full bg-gradient-to-r from-zinc-900 to-[rgba(21, 21, 21, 0)]">
          ...
          <p className="text-slate-300 font-semibold w-2/3 md:w-2/4 ms-10 mt-6">Explore our thrilling toy car collection for endless fun and excitement. From sleek sports cars to rugged off-road vehicles, ignite your imagination and start creating unforgettable adventures today!</p>
          <div className="pb-20">
